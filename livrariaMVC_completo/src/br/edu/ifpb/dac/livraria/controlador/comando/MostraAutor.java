...
public class MostraAutor implements Comando{
	...
	public void executa(HttpServletRequest request, HttpServletResponse response)
		...
		Autor autor = autorDao.buscaPelaId(id);

		request.setAttribute("autor", autor);
		
		RequestDispatcher rd = request.getRequestDispatcher("WEB-INF/visao/formAlteraAutor.jsp");
